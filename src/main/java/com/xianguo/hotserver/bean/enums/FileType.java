...
public enum FileType {
	TYPE_ALL("*","application/octet-stream"),
	TYPE_001("001","application/x-001"),
	TYPE_301("301","application/x-301"),
	TYPE_323("323","text/h323"),
	TYPE_906("906","application/x-906"),
	...
	FileType(String file,String contentType){
		this.file = file;
	...
	public static FileType ValueOf(String file) {
		for(FileType fileType : values()) {
			if(fileType.getFile().equals(file)) {
				return fileType;
			}
		}
		return null;
	...
	public String getContentType() {
		String charset = "; charset="+ServerConstant.ENCODE;
		switch (this) {
		case HTML:
